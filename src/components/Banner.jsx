            ...
            <div className="py-5 text-white flex flex-col md:flex-row justify-around items-center gap-4 mx-auto ">
                ...
                <div className="md:w-1/2">
                    ...
                    <a href="https://wa.me/7011652617" target="_blank" rel="noopener noreferrer" className="font-semibold md:font-bold 2xl:text-sm md:text-sm text-md">
                        <button className="py-2 px-5 rounded-md bg-purple-500 hover:bg-sky-700">Let's Talk<i className="fa-brands fa-whatsapp mx-2 2xl:text-lg md:text-sm text-md"></i></button>
                    </a>

                    <div className="mt-6 mb-8 flex gap-4 items-center">
                        <div className="2xl:gap-2 flex">
                            <a href="https://www.instagram.com/abhikumar_sh/?igsh=MTUxcGJoZDJtc3dqeA%3D%3D" target="_blank"><i className="fa-brands fa-instagram text-2xl 2xl:text-3xl text-purple-500 w-8 h-8"></i></a>
                            <a href="https://www.linkedin.com/in/abhishek-kumar-a06048165/" target="_blank"><i className="fa-brands fa-linkedin text-2xl 2xl:text-3xl text-purple-500 w-8 h-8"></i></a>
                            <a href="https://github.com/Abhi-prasad7042" target="_blank"><i className="fa-brands fa-github text-2xl 2xl:text-3xl text-purple-500 w-8 h-8"></i></a>
                        </div>
                    </div>
                </div>
