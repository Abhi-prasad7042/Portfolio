...
const Skill = ()=>{
    return(
        <section className="max-w-[1200px] 2xl:max-w-[1400px] mx-auto px-5 mb-10 ">
          ...
          play={true}
          direction="left">
                    <div className="border-2 my-2 md:w-[130px] w-[100px] md:h-[120px] h-[100px] rounded-lg border-[#0872BF] shadow-purple-500 shadow-sm md:mx-12 mx-8 transition-all duration-500 hover:scale-[1.03] cursor-pointer">
                    ...
                    <div className="border-2 md:w-[140px] w-[100px] md:h-[120px] h-[100px] rounded-lg border-[#0872BF] shadow-purple-500 shadow-sm md:mx-12 mx-8 transition-all duration-500 hover:scale-[1.03] cursor-pointer">
